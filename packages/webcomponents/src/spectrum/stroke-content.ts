...
export class StrokeContent extends LitElement {
  ...
  render() {
    ...
    const strokeWidthBound =
      typeof strokeWidth === 'string' && isDesignVariableReference(strokeWidth);
    ...
    return html`<div class="line">
        ...
        <div class="stroke-width-controls">
          <sp-action-button quiet size="s" id="stroke-width-dv-trigger">
      ...
      <div class="line">
        ...
        >
        <div class="stroke-width-controls">
          <sp-action-button quiet size="s" id="stroke-opacity-dv-trigger">
            <sp-icon-link slot="icon"></sp-icon-link>
            <sp-tooltip self-managed placement="bottom">
              ${msg(str`Attach a variable`)}
            </sp-tooltip>
